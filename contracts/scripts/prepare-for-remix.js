...
function prepareContractsForRemix() {
  ...
  const contracts = [
    'HyperLaunchERC721_ImplV2_Simple.sol',
    'HyperLaunch721FactoryV2.sol'
  ];
  ...
  const deploymentParams = {
    ...
    deploymentOrder: [
      {
        step: 1,
        contract: "HyperLaunchERC721_ImplV2_Simple",
        constructorParams: [],
        description: "Deploy implementation contract (no parameters needed)"
      },
      {
        step: 2,
    ...
    gasLimits: {
      HyperLaunchERC721_ImplV2_Simple: 8000000,
      HyperLaunch721FactoryV2: 6000000
    }
  };
