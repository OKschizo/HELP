...
function promptPrivateKey(): Promise<string> {
  return new Promise((resolve) => {
    ...
    stdout.write("🔑 Enter your deployment wallet private key (input will be hidden): ");
...
async function deployImplementation(wallet: ethers.Wallet) {
...
async function deployFactory(wallet: ethers.Wallet, implementationAddress: string, config: any) {
...
export { main as interactiveDeploy };
