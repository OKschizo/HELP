...
export default function DeployFactoryPage() {
  ...
  const ADMIN_ADDRESS = '0x97eC9428a7CBC648e03896F48f176D1B1859475e'
  const allowed = address && address.toLowerCase() === ADMIN_ADDRESS.toLowerCase()
    ...
    <AuthGuard>
      <div className="min-h-screen bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 p-4">
        <div className="max-w-4xl mx-auto">
          ...
          {address && !allowed && (
            <div className="text-center text-sm text-gray-300 mb-8">This page is restricted.</div>
          )}
