import {
  ...
  waitForTransactionReceipt, estimateGas, type Hex,
} from 'viem';
...
import ImplArtifact from '../../packages/contracts/artifacts/contracts/HyperLaunchERC721_ImplV2_Optimized.sol/HyperLaunchERC721_ImplV2.json';

// Use the real ABI and bytecode from compiled contract
const ImplAbi = ImplArtifact.abi;
...
export async function deployImplementation(useManualGas: boolean = false): Promise<DeploymentResult> {
  ...
  try {
    ...
    const errorMessage = explainError(e, ImplAbi);
