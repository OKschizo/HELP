              ...
              <div className="flex flex-col items-center">
                ...
                <div
                  className={cn(
                    ...
                    {
                      // Completed: Modern success state
                      'bg-gradient-to-r from-[var(--hl-cyan)] to-[var(--hl-azure)] border-transparent text-[#07131A] shadow-[var(--shadow-glow-cyan)]': isCompleted,
                      // Current: Active with glow
                      'bg-[var(--bg-elevated)] border-[var(--hl-azure)] text-[var(--hl-azure)] shadow-[0_0_0_4px_rgba(59,130,246,0.1)]': isCurrent,
                      // Upcoming: Subtle and modern
                      'bg-[var(--bg-subtle)] border-[var(--stroke-soft)] text-[var(--fg-subtle)]': isUpcoming,
                    }
                  )}
                ...
                <div className="mt-3 text-center">
                  <div className={cn(
                    ...
                    {
                      'text-[var(--hl-azure)]': isCurrent,
                      'text-[var(--fg-default)]': isCompleted,
                      'text-[var(--fg-muted)]': isUpcoming,
                    }
                  )}>
