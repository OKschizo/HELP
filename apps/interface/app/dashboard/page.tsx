          ...
          for (const a of addrs) {
            try {
              ...
              const [name, symbol, totalSupply, maxSupply, paused, sale] = await Promise.all([
                publicClient.readContract({ address: addr, abi: IMPLEMENTATION_ABI as any, functionName: 'name' }) as any,
                publicClient.readContract({ address: addr, abi: IMPLEMENTATION_ABI as any, functionName: 'symbol' }) as any,
                publicClient.readContract({ address: addr, abi: IMPLEMENTATION_ABI as any, functionName: 'totalSupply' }) as any,
                publicClient.readContract({ address: addr, abi: IMPLEMENTATION_ABI as any, functionName: 'maxSupply' }) as any,
                publicClient.readContract({ address: addr, abi: IMPLEMENTATION_ABI as any, functionName: 'paused' }) as any,
                publicClient.readContract({ address: addr, abi: IMPLEMENTATION_ABI as any, functionName: 'saleConfig' }) as any,
              ])
              out[a] = {
                name: name as string,
